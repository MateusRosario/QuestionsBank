...
public class TelaBusca extends JFrame {
    ...
    JLabel excluir;
    JLabel editar;
    BuscaMouseListener[] buscaMouseListeners = new BuscaMouseListener[3];
    int tamBuscaMouse=0;
    //}------------------------------
    ...
    public TelaBusca(Admin admin, String assunto) {
        this.admin = admin;
        this.i = 2;
...
//
    ...
    public void adicionaListaQuestoes() {
        for (int i = 0; i < resultados.size(); i++) {
            ...
            formatL4(painel);
            painel.addMouseListener(new BuscaMouseListener(5, painel, "", this, admin));
    ...
    public void saveMouseListener(BuscaMouseListener buscaMouseListener){
        this.buscaMouseListeners[tamBuscaMouse]=buscaMouseListener;
        tamBuscaMouse++;
    }
}
