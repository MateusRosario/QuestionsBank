...
public class TelaInformaçõesVouF extends JFrame {
    ...
    public TelaInformaçõesVouF(Questao questao){
    ...
    public void elementosDoPainelCentro(){
        ...
        format(pergunta);
        resposta = new JLabel("Resposta: " + (((((VouF) questao).getResposta())?"Verdadeiro":"Falso")));
        format(resposta);
